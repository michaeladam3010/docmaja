package com.docmala.plugins.document.internal_formula;

import com.docmala.plugins.document.internal_formula.antlr.VanesaFormulaBaseVisitor;
...
public class VanesaFormulaParseRules extends VanesaFormulaBaseVisitor<String> {
    ...
    * @return The text content of this node.
	 */
	@Override
   public String visitNumber(VanesaFormulaParser.NumberContext ctx) {
      return ctx.getText();
   }
    ...
    * @return The number wrapped in "(-" and ")".
	 */
	@Override
   public String visitNeg_number(VanesaFormulaParser.Neg_numberContext ctx) {
    ...
    * in curly braces.
	 */
	@Override
   public String visitVariable(VanesaFormulaParser.VariableContext ctx) {
    ...
    * @return Returns the internal_formula string of the term node (including all its children)
    * formatted according to the rules specified in this function.
	 */
	@Override
   public String visitTerm(VanesaFormulaParser.TermContext ctx) {
      String ret;
