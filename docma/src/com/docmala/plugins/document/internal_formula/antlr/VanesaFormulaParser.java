...
public class VanesaFormulaParser extends Parser {
    ...
    public static class ExprContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitExpr(this);
    ...
    public static class TermContext extends ParserRuleContext {
        ...
        public TerminalNode LPAREN() {
            return getToken(VanesaFormulaParser.LPAREN, 0);
        }
        ...
        public TerminalNode RPAREN() {
            return getToken(VanesaFormulaParser.RPAREN, 0);
        }
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(VanesaFormulaParser.COMMA);
        }
        ...
        public TerminalNode POW() {
            return getToken(VanesaFormulaParser.POW, 0);
        }

        public TerminalNode DIV() {
            return getToken(VanesaFormulaParser.DIV, 0);
        }

        public TerminalNode MULT() {
            return getToken(VanesaFormulaParser.MULT, 0);
        }

        public TerminalNode PLUS() {
            return getToken(VanesaFormulaParser.PLUS, 0);
        }

        public TerminalNode MINUS() {
            return getToken(VanesaFormulaParser.MINUS, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitTerm(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AtomContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitAtom(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumberContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NUMBER() {
            return getTokens(VanesaFormulaParser.NUMBER);
        }
        ...
        public TerminalNode DOT() {
            return getToken(VanesaFormulaParser.DOT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitNumber(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Neg_numberContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_neg_number;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitNeg_number(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VariableContext extends ParserRuleContext {
        ...
        public TerminalNode VARIABLE() {
            return getToken(VanesaFormulaParser.VARIABLE, 0);
        }

        public List<TerminalNode> INDEX() {
            return getTokens(VanesaFormulaParser.INDEX);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitVariable(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Neg_variableContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_neg_variable;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitNeg_variable(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof VanesaFormulaVisitor)
                return ((VanesaFormulaVisitor<? extends T>) visitor).visitFunction(this);
            else return visitor.visitChildren(this);
        }
    }
}